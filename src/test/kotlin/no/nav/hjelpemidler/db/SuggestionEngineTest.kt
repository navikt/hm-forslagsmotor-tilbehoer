...
internal class SuggestionEngineTest {
    ...
    private var ds = TestDatabase.datasource

    private fun suggestionEngine() =
        SuggestionEnginePostgres(ds, aivenMetricsMock, hjelpemiddeldatabaseClient, oebs)
